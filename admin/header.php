...
<head>
    ...
    <title>Admin - SIAD UKM ALFA OMEGA</title>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <!-- <a href="index.html"><img class="main-logo" src="../assets/img/logo/A" alt="" /></a> -->
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="#" class="nav-link">Sistem Informasi Arsip Digital UKM Alfa Omega Unmus</a></li>
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <div class="mobile-menu">
                        <nav id="dropdown">
                            <ul class="mobile-menu-nav">
                                ...
                                <li>
                                    <a href="petugas.php" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Data Pengurus</span></a>
                                </li>
